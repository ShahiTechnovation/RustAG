...
const COLUMNS = [
  ...
  },
  {
    title: "Features",
    links: [
      { label: "multisig decoder", href: "#features" },
  ...
  return (
    <footer className="border-t border-border px-6 py-14">
      <div className="mx-auto grid max-w-6xl gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted">
            The GroundTruth pre-execution assurance layer for Robinhood Chain — know exactly what a
      ...
      <div className="mx-auto mt-12 max-w-6xl border-t border-border pt-6 text-xs text-faint">
        © {new Date().getFullYear()} RustAG · GroundTruth for Robinhood Chain. Built for the ecosystem.
      </div>
    </footer>
  );
}
