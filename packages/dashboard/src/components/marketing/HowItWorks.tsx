...
const STEPS = [
  {
    ...
    body: "Give RustAG a multisig proposal address (or a raw base64 transaction). It fetches the exact pre-state — every account, every ProgramData, the Clock sysvar — from N independent mainnet RPC endpoints.",
  },
  {
    n: "02",
    title: "Sealed rehearsal",
    body: "The payload runs in a sealed, deterministic EVM sandbox against the pinned pre-state snapshot. Two-pass execution: discover all touched accounts, then re-execute with no live RPC calls.",
  },
  {
    n: "03",
