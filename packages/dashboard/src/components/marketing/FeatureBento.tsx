...
export function FeatureBento() {
  return (
    <Section
      ...
      description="From multisig proposal decoding to counterfactual forensics — the complete toolkit for pre-execution assurance on Robinhood Chain."
    >
      <Reveal>
        <div className="grid auto-rows-[minmax(0,1fr)] grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <BentoCard
            ...
            description="Two-pass deterministic execution in a sealed EVM sandbox. Pass 1 discovers all touched accounts. Pass 2 re-executes with zero live RPC calls, producing a SHA-256 content-addressed state root — Grade A means anyone can re-verify."
            media={<MirrorPills />}
          />
          ...
          <BentoCard
            ...
            description="Upgrade authority rotation, program freeze, new durable-nonce, ETH drain (>80%), and the Drift attack pattern (nonce + authority combo) all trigger typed alarms."
            media={<AlarmPills />}
          />
