...
export const metadata: Metadata = {
  title: "Introduction",
  description:
    "RustAG is the GroundTruth layer for Robinhood Chain — attested pre-execution assurance for privileged operations. Rehearse multisig proposals, get signed EvidenceBundles, run counterfactual forensics.",
};
...
const CATEGORIES = [
  ...
  },
  {
    ...
    icon: <Code2 size={18} />,
    title: "SDK & API",
    desc: "@rustag/sdk, POST /api/rehearse, POST /api/verify, and the Robinhood Chain JSON-RPC surface.",
    meta: "Reference",
  },
  {
    ...
    icon: <Plug size={18} />,
    title: "Architecture",
    desc: "Dual-layer design: Ingest (TouchSet, multisig, MultiRpc) + Sealed Rehearsal (EVM sandbox, semantic diff, invariant policy).",
    meta: "Advanced",
  },
  {
    href: "/docs/security",
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted">
              RustAG rehearses any Robinhood Chain transaction against faithful mainnet state in a sealed sandbox
              — then emits a{" "}
        ...
        <div className="mt-10 flex flex-col gap-3 rounded-[5px] border border-brand/30 bg-brand/[0.05] px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted">
              ...
              mirror, dirty/clean tracking, unlimited airdrops, Robinhood Chain-compatible RPC, persistence, CLI,
          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-pretty leading-relaxed text-muted">
                Every account carries a sync state. It is how RustAG replays mainnet on a local EVM with no
        ...
        <section className="mt-20">
          <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-pretty leading-relaxed text-muted">
                A stagenet exposes a Robinhood Chain-compatible JSON-RPC on{" "}
