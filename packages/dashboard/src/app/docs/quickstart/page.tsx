...
export const metadata: Metadata = {
  title: "Quickstart",
  description:
    "From install to a signed EvidenceBundle in under two minutes — build the CLI, run the built-in demo, then rehearse a real multisig proposal from mainnet.",
};
...
#  ✓ Signed by: ephemeral key (pubkey printed above)`}
      ...
      <p>
        Point RustAG at a live multisig VaultTransaction proposal address. It fetches, decodes,
...
# open http://localhost:3000`}
      ...
      <Callout variant="early">
        The CLI and REST API are the working Phase 1 deliverable. The multisig web UI integration
