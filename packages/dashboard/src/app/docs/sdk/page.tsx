...
export const metadata: Metadata = {
  title: "SDK & API",
  description:
    "The @rustag/sdk TypeScript client, POST /api/rehearse and POST /api/verify REST endpoints, and the Robinhood Chain JSON-RPC surface used during closure resolution.",
};
...
export default function SdkPage() {
  return (
    <DocArticle
      eyebrow="Reference"
      title="SDK & API"
      lead="Three ways to drive RustAG: the @rustag/sdk TypeScript client over REST, the raw REST contract the dashboard sits on, and the Robinhood Chain-compatible JSON-RPC used during closure resolution."
      toc={TOC}
    >
...
curl -s http://127.0.0.1:9000/api/verify \\
  ...
  -d '{"bundle": <BUNDLE_JSON>, "closure": <CLOSURE_JSON>}'`}
      ...
      <p>
        The stagenet speaks a Robinhood Chain-compatible JSON-RPC dialect on{" "}
...
await connection.requestAirdrop(pubkey, 2_000_000_000); // 2 ETH, no faucet limit`}
      />
