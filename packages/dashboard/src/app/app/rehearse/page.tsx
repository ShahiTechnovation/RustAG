...
export const metadata: Metadata = {
  title: "Rehearse",
  description: "Rehearse a multisig proposal or raw transaction against faithful mainnet state and get a signed EvidenceBundle.",
};
    ...
    <div className="mx-auto max-w-3xl space-y-10">
      ...
      <div>
        ...
        <p className="mt-3 max-w-xl text-base leading-relaxed text-muted">
          Rehearse a multisig proposal or raw transaction against pinned mainnet state in a sealed
