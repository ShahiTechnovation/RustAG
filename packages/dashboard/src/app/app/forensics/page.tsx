...
export const metadata: Metadata = {
  title: "Forensics",
  description: "Re-execute historical Robinhood Chain transactions and run counterfactual patch analysis.",
};
    ...
    <div className="mx-auto max-w-3xl space-y-10">
      ...
      <div className="rounded-[3px] border border-border bg-surface/40 p-5 space-y-3">
        ...
        <ol className="space-y-2 text-xs text-muted leading-relaxed list-decimal list-inside">
          ...
          <li>Re-execute in a sealed EVM sandbox — the EVM has no network access.</li>
