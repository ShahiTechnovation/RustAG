    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          RustAG GroundTruth — attested pre-execution assurance for Robinhood Chain privileged operations.
        </p>
      </div>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted leading-relaxed">
              Paste a multisig proposal pubkey or a base64 transaction — get a signed
              EvidenceBundle back.
            </p>
          </div>
