...
// Robinhood Chain addresses are base58-encoded 32-byte public keys (no 0,O,I,l).
...
export async function POST(request: Request) {
  ...
  if (!SOLANA_RE.test(wallet)) errors.wallet = "Enter a valid Robinhood Chain wallet address.";
