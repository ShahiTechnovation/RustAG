...
/// artifact. Re-exported from `rustag-core` so the CLI, REST server, and cloud
/// control plane share one credential-redaction implementation (tested there).
pub use rustag_core::redact_url;
